...
{/* id,                                     grp, pos,   up,                       down,                             text,           callback                      flags                  */
	...
	{LCD_MENU_ID_Joystick,                    0,   1,   LCD_MENU_ID_NONE,         LCD_MENU_ID_Joystick_ON,            "Joystick",      NULL,                         LCDMENU_MENU_FLAGS_NONE},
	  {LCD_MENU_ID_Joystick_ON,               2,   0,   LCD_MENU_ID_Joystick,         LCD_MENU_ID_NONE,                 NULL,           JoystickMenuHandler,           LCDMENU_MENU_FLAGS_NONE},
	  {LCD_MENU_ID_Test,          		      2,   1,   LCD_MENU_ID_Joystick,         LCD_MENU_ID_NONE,            "Test Network",           JoystickTestHandler,           LCDMENU_MENU_FLAGS_NONE},
	  {LCD_MENU_ID_Speed,                     2,   2,   LCD_MENU_ID_Joystick,         LCD_MENU_ID_NONE,                 NULL,           SpeedChangeHandler,           LCDMENU_MENU_FLAGS_EDITABLE},
	  {LCD_MENU_ID_SpeedLine,                 2,   3,   LCD_MENU_ID_Joystick,         LCD_MENU_ID_NONE,                 NULL,           SpeedLineChangeHandler,       LCDMENU_MENU_FLAGS_EDITABLE},
