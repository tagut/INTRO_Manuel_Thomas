...
void PID_Init(void) {
  ...
  speedLeftConfig.iAntiWindup = 7000;
  speedLeftConfig.lastError = 0;
  speedLeftConfig.integral = 0;

  speedRightConfig.pFactor100 = 2300;
  speedRightConfig.iFactor100 = 150;
  speedRightConfig.dFactor100 = 10;
  speedRightConfig.iAntiWindup = 7000;
  speedRightConfig.lastError = 0;
  speedRightConfig.integral = 0;

  lineFwConfig.pFactor100 = 1200;
  lineFwConfig.iFactor100 = 0;
  lineFwConfig.dFactor100 = 0;
  lineFwConfig.iAntiWindup = 5000;
